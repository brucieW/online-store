...
import com.zeroboss.store.domain.Shipment;
import com.zeroboss.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link com.zeroboss.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
