...
import com.zeroboss.store.domain.ProductCategory;
import com.zeroboss.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.zeroboss.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
